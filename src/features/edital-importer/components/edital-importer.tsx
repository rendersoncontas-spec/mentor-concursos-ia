...
export function EditalImporter({ targetId }: { targetId: string }) {
  ...
  const renderBody = () => {
    ...
    if (!result || !draft) {
      return (
        <div
          className={`flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed px-6 py-8 text-center transition-colors ${
        ...
        >
          ...
          <div>
            <p className="text-sm font-semibold text-foreground">Arraste o arquivo do edital aqui</p>
          ...
          <button
            ...
            className="mt-1 inline-flex items-center gap-1.5 rounded-xl border bg-background px-4 py-2 text-xs font-semibold text-foreground transition-colors hover:bg-muted"
          >
  ...
  return (
    <Dialog.Root open={open} onOpenChange={(o) => {
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 flex max-h-[85vh] w-[min(720px,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 flex-col rounded-lg border bg-card shadow-xl">
    ...
    <div className="space-y-4">
      ...
      {(draft.metadata.name || draft.metadata.organizer || draft.metadata.banca) && (
        <div className="rounded-xl border bg-muted/40 px-4 py-3 text-xs space-y-1">
          {draft.metadata.name && (
            <p>
              <span className="font-semibold text-foreground">Edital:</span>{" "}
            ...
            <div className="flex items-center gap-2 border-b bg-muted/30 px-3 py-2">
              ...
              {editing?.disc === i && editing.topic === null ? (
                <input
                  ...
                  className="flex-1 rounded-lg border bg-background px-2 py-1 text-sm font-semibold text-foreground"
                />
              ) : (
                <button
                  type="button"
  ...
  return (
    <div className="mt-1.5 flex items-center gap-1.5">
      ...
      <button
        ...
        className="rounded-lg border px-2 py-1.5 text-xs font-semibold text-foreground transition-colors hover:bg-muted"
      >
