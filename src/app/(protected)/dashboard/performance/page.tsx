...
export const metadata = {
  title: "Performance - Mentor Concursos IA",
}
      ...
      <main className="flex-1 space-y-6 p-4 md:p-8 pt-6">
        <div className="flex flex-col space-y-4">
          ...
          <nav className="flex space-x-4 border-b pb-2 text-sm overflow-x-auto">
            ...
            <Link href="/dashboard/performance" className="font-semibold text-primary border-b-2 border-primary pb-2">Performance</Link>
            ...
            <Link href="/dashboard/adaptive" className="text-muted-foreground hover:text-foreground">Adaptativo (ALE)</Link>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="border rounded-lg p-4 bg-card col-span-full md:col-span-1">
            <h3 className="font-semibold text-sm text-muted-foreground mb-4">Radar de Desempenho</h3>
            {radarData.length === 0 ? (
                ...
                {accuracyData.map(acc => (
                  <div key={acc.id} className="flex items-center justify-between p-3 border rounded-md">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">{acc.correctAttempts} acertos de {acc.totalAttempts} tentativas</p>
                    </div>
